...
$sentencia = $base_de_datos->prepare("SELECT id, t_documento,num_documento,remitente,area_remi,destinatario,area_dest,contenido,vistos FROM documentos WHERE id = ?;");
$sentencia->execute([$id]);
$mascota = $sentencia->fetchObject();
if (!$mascota) {
    #No existe
    echo "¡No existe algun documento  con ese ID!";
    exit();
}
